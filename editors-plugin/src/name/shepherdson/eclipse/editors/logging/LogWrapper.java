...
package name.shepherdson.eclipse.editors.logging;
...
public class LogWrapper
{
    ...
    public void info(Exception e, String message, Object... messageVariables)
    {
        ...
        Status status =
                new Status(IStatus.INFO, Activator.PLUGIN_ID, clazz.getName() + ":" + message, e);
        log.log(status);
    }
    ...
    public void error(Exception e, String message, Object... messageVariables)
    {
        ...
        Status status =
                new Status(IStatus.ERROR, Activator.PLUGIN_ID, clazz.getName() + ":" + message, e);
        log.log(status);
    }
